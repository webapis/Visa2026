...
- **`.cursor/skills/visa2026-user-report-templates/SKILL.md`** (+ **`reference*.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: user report template **seeds** under **`Resources/Templates/`** (Word/Excel embed, maps, Extract/Validate, merge families); not dialog UX (see **resminamalar**); not in-browser Spreadsheet tab editing (see **visa2026-excel-inplace-editor**).
- **`.cursor/skills/visa2026-excel-inplace-editor/SKILL.md`** (+ **`reference.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **Excel User Report Template** in-browser editor (DevExpress Spreadsheet iframe, Save to template, Reload, lazy load/layout); not repo seeds (**user-report-templates**) or Resminamalar (**resminamalar**). Canonical **`docs/EXCEL_TEMPLATE_INPLACE_EDITOR.md`**.
