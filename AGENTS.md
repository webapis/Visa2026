...
- **[`docs/APPLICATION_REPORT_PACKAGE.md`](docs/APPLICATION_REPORT_PACKAGE.md)** — **Resminamalar** report package dialog on `Application` detail: improved successor to one-click Word/Excel ZIP (catalog, readiness, selection, preview, **UNC template staging**); same `WordReportGenerationBatch` engine. Staging plan: **[`docs/TEMPLATE_STAGING_EDIT.md`](docs/TEMPLATE_STAGING_EDIT.md)**.
