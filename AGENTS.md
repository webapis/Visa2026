...
- **`.cursor/skills/visa2026-resminamalar/SKILL.md`** (+ **`prompts.md`**, **`reference.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **Resminamalar** report package dialog; **read learnings before / append after verified fixes**; scenarios promote from experience. Canonical **`docs/APPLICATION_REPORT_PACKAGE.md`**.
