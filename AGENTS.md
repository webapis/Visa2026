...
- **`.cursor/skills/visa2026-user-report-template-editing/SKILL.md`** (+ **`reference.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: in-app **`TemplateEditor`** preview-slot occupant (Word **`DxRichEdit`**, Excel upload strip → **Univer** / ONLYOFFICE); canonical **`docs/USER_REPORT_TEMPLATE_IN_APP_EDITING_PLAN.md`**.
