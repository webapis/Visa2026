...
- **`.cursor/skills/visa2026-easytest-e2e/SKILL.md`** (+ **`reference.md`**, **`user-prompts.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **native XAF EasyTest E2E** (`Visa2026.E2E.Tests`, C# API, Edge/Selenium, **:5050** / `Visa2026EasyTest`); **UserManual** journeys captured by **`Build-UserManual.ps1`** ([`docs/USER_MANUAL_PIPELINE.md`](docs/USER_MANUAL_PIPELINE.md)); full regression in **`e2e-tests.yml`**.
