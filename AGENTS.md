...
- **`.cursor/skills/visa2026-application-profile/SKILL.md`** (+ **`reference.md`**, **`IMPLEMENTATION_PLAN.md`**, **`prompts.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — **sole** Agent **Skill** for Application Profile implementation: seed/cutover, wizard, picker, config lock, officer configuration suggestions, slice tracking — not progress transitions (**visa2026-application-progress**), Resminamalar (**visa2026-resminamalar**), or **Create from scan** (**visa2026-template-scan**).
- **`.cursor/skills/visa2026-template-scan/SKILL.md`** (+ **`reference.md`**, **`prompts.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — **Create template from scan**: improve **Word and Excel** merge templates from scanned document images (yellow PNG/PDF → vision field plan → draft → Approve). Word path shipped; Excel-from-scan is a skill improvement target. Not Convert (`TEMPLATE_AI_CONVERT_*`), Resminamalar ZIP, or embedding `#visa-preview-slot` inside the scan wizard. Canonical **`docs/TEMPLATE_AI_SCAN_PRODUCT_SPEC.md`**.
