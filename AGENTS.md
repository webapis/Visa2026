...
- **`.cursor/skills/visa2026-document-copies/SKILL.md`** (+ **`prompts.md`**, **`reference.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **Document copies** dialog (scan preview, package enqueue, PDF toast); **not** XFA mapping — see **pdf-form-mapping**. Canonical **`docs/APPLICATION_ITEM_DOCUMENT_COPIES.md`**. **ApplicationItem scope only** — Person master-data catalog: **`visa2026-person-document-copies`** + **`docs/PERSON_DOCUMENT_COPIES.md`** (planned).
- **`.cursor/skills/visa2026-person-document-copies/SKILL.md`** (+ **`reference.md`**, **`prompts.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **Person-scoped** document copies in preview slot (sectioned child BO attachments, preview-first); Phase 1 shipped (DetailView). Not ministry ZIP — see **document-copies** for ApplicationItem. Canonical **`docs/PERSON_DOCUMENT_COPIES.md`**.
