...
- **`.cursor/skills/visa2026-document-copies/SKILL.md`** (+ **`prompts.md`**, **`reference.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **Document copies** dialog (scan preview, package enqueue, PDF toast); **not** XFA mapping — see **pdf-form-mapping**. Canonical **`docs/APPLICATION_ITEM_DOCUMENT_COPIES.md`**.
