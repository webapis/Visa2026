...
- **`.cursor/skills/visa2026-person-document-copies/SKILL.md`** (+ **`reference.md`**, **`prompts.md`**, **`MATURITY.md`**, append-only **`learnings.md`**) — optional Agent **Skill**: **planned** Person-scoped document copies in preview slot (sectioned child BO attachments, preview-first); not ministry ZIP — see **document-copies** for ApplicationItem. Canonical **`docs/PERSON_DOCUMENT_COPIES.md`**.
