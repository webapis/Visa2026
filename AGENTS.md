...
- **[`docs/VISA2014_MIGRATION/EXCEL_PREVIEW_EXPORT.md`](docs/VISA2014_MIGRATION/EXCEL_PREVIEW_EXPORT.md)** — consolidated **`VISA2015` → Excel** to preview import content before OData.
