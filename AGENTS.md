...
- **[`docs/APPLICATION_PROGRESS_APPROVAL_AND_CONTRACT_DEPTH.md`](docs/APPLICATION_PROGRESS_APPROVAL_AND_CONTRACT_DEPTH.md)** — approval step flows (ministry legs, direct migration), `ProjectContract.MinistryReviewDepth`, resolver and business rules.
