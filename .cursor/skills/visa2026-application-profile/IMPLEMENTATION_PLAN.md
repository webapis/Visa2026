...
| 8d | Wizard step 4 real template catalog + persist scope | **Done** | Two officer scopes: Profile-specific and Shared. Shared list Include/Exclude only (no Category/Global labels, no suggestion, no family chips). Edit/Add pills match. Internal Category/Global type-links unchanged. |
