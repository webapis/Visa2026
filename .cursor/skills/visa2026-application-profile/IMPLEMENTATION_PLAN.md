...
| 8d | Wizard step 4 real template catalog + persist scope | **Done** | Live shared catalog (typed + global masters) with Include/Exclude; family tags on the right; Suggested vs All. Edit Scope still Category/Global. Clone to profile-specific. |
