...
| 4b | 2 | `family-member/register` | Register a family member | Person | — | create | `person-officer-journey` | Officer review pending; Playwright E2E (doc-anchored) | **doc-anchored** | **review** | 2 |
