...
| `ApplicationDirectMigration` | `app-status` (Application Status) | Real EF `Application` + `DirectToMigrationService`; Open ListView → `Application_ListView_DirectMigration` |
