...
public class ScanGuessingPatternRegistryTests
{
    ...
    public void Excel_profiles_match_purpose_and_inviting_party()
    {
        ...
        Assert.Equal("CWLB", ScanExcelColumnProfiles.Match("Hereket edýän çägi")!.ShortCodes[0]);
        ...
        Assert.Equal("VNUM", ScanExcelColumnProfiles.Match("Möhleti we gezekligi")!.ShortCodes[0]);
        Assert.Contains("VSTD", ScanExcelColumnProfiles.Match("Möhleti we gezekligi")!.ShortCodes);
    }
