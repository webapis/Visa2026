...
internal static class Visa2014RejectionItemPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014RejectionItemTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/RejectionItem.yaml"),
        };
        ...
        [
            ...
            {
                Name = "RejectionItem",
                Columns = Visa2014RejectionItemTransform.RejectionItemMainColumnOrder,
                Rows = batch.ImportRows,
            },
            new Visa2014Worksheet
            {
                Name = "_Skipped",
                Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014RejectionItemTransform.RejectionItemMainColumnOrder),
