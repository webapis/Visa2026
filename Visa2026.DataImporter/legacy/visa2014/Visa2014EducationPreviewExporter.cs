...
internal static class Visa2014EducationPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014EducationTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/Education.yaml"),
        };
        ...
        [
            new Visa2014Worksheet { Name = "Education", Columns = Visa2014EducationTransform.EducationMainColumnOrder, Rows = batch.ImportRows },
            new Visa2014Worksheet { Name = "_Skipped", Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014EducationTransform.EducationMainColumnOrder), Rows = batch.Skipped.ToList() },
