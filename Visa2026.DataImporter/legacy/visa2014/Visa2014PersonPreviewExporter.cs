...
internal sealed class Visa2014PreviewExportResult
{
    public required string OutputPath { get; init; }
    public int LegacyRowCount { get; init; }
    public int ImportRowCount { get; init; }
    public int SkippedRowCount { get; init; }
    public int DedupeMergedCount { get; init; }
    public int UnmappedLookupCount { get; init; }
}

internal static class Visa2014PersonPreviewExporter
{
        ...
        bool verbose)
    {
        ...
        [
            new Visa2014Worksheet { Name = "Person", Columns = Visa2014PersonTransform.PersonMainColumnOrder, Rows = batch.ImportRows },
            new Visa2014Worksheet { Name = "_Skipped", Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014PersonTransform.PersonMainColumnOrder), Rows = batch.Skipped.ToList() },
