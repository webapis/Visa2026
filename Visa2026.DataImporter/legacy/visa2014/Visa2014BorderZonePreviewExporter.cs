...
internal static class Visa2014BorderZonePreviewExporter
{
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/BorderZone.yaml"),
        };
        ...
        [
            ...
            {
                Name = "BorderZone",
                Columns = Visa2014BorderZoneTransform.BorderZoneMainColumnOrder,
                Rows = batch.ImportRows,
            },
            new Visa2014Worksheet
            {
                Name = "_Skipped",
                Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014BorderZoneTransform.BorderZoneMainColumnOrder),
