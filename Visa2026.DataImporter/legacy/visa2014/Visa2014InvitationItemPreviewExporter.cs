...
internal static class Visa2014InvitationItemPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014InvitationItemTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "entity", "InvitationItem"),
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/InvitationItem.yaml"),
        };
        ...
        [
            ...
            {
                Name = "InvitationItem",
                Columns = Visa2014InvitationItemTransform.InvitationItemMainColumnOrder,
                Rows = batch.ImportRows,
            },
            new Visa2014Worksheet
            {
                Name = "_Skipped",
                Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014InvitationItemTransform.InvitationItemMainColumnOrder),
