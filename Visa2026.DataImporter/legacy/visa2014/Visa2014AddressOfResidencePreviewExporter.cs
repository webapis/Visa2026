...
internal static class Visa2014AddressOfResidencePreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014AddressOfResidenceTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "entity", "AddressOfResidence"),
        ...
        [
            new Visa2014Worksheet { Name = "AddressOfResidence", Columns = Visa2014AddressOfResidenceTransform.AddressOfResidenceMainColumnOrder, Rows = batch.ImportRows },
            new Visa2014Worksheet { Name = "_Skipped", Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), ["_legacyRowId", "reason", "_legacy_AddressLine", "_legacy_PersonOid"]), Rows = batch.Skipped.ToList() },
