...
internal static class Visa2014WorkPermitItemPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014WorkPermitItemTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "entity", "WorkPermitItem"),
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/WorkPermitItem.yaml"),
        };
        ...
        [
            ...
            {
                Name = "WorkPermitItem",
                Columns = Visa2014WorkPermitItemTransform.WorkPermitItemMainColumnOrder,
                Rows = batch.ImportRows,
            },
            new Visa2014Worksheet
            {
                Name = "_Skipped",
                Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014WorkPermitItemTransform.WorkPermitItemMainColumnOrder),
