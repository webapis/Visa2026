...
internal static class Visa2014BorderZoneItemPreviewExporter
{
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "entity", "BorderZoneItem"),
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/BorderZoneItem.yaml"),
        };
        ...
        [
            ...
            {
                Name = "BorderZoneItem",
                Columns = Visa2014BorderZoneItemTransform.BorderZoneItemMainColumnOrder,
                Rows = batch.ImportRows,
            },
            new Visa2014Worksheet
            {
                Name = "_Skipped",
                Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014BorderZoneItemTransform.BorderZoneItemMainColumnOrder),
