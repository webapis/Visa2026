...
internal static class Visa2014VisaPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014VisaTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/Visa.yaml"),
        };
        ...
        [
            new Visa2014Worksheet { Name = "Visa", Columns = Visa2014VisaTransform.VisaMainColumnOrder, Rows = batch.ImportRows },
            new Visa2014Worksheet { Name = "_Skipped", Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014VisaTransform.VisaMainColumnOrder), Rows = batch.Skipped.ToList() },
