...
internal static class Visa2014EmployeePositionHistoryTransform
{
    ...
    [
        ...
        "_legacy_PositionTitle", "_legacy_DepartmentTitle", "_legacy_PositionCode", "_legacy_PersonOid",
    ];
        ...
        out List<Dictionary<string, object?>> dedupeSummary)
    {
        ...
        {
            var row = BuildExportRow(raw, catalogs, endDates, out var skipReason, out var rowUnmapped);
        ...
        out List<string> unmapped)
    {
        ...
        row["ActualPosition"] = ResolveActualPosition(raw.PositionCode);
