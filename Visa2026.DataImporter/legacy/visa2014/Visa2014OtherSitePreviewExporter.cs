...
internal static class Visa2014OtherSitePreviewExporter
{
        ...
        string? legacySourceId = null)
    {
        ...
        var batch = Visa2014OtherSiteTransform.PrepareImportBatch(
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "source", "VISA2015 Address (Lojman lines not Hotel/Lodging)"),
        ...
        [
            new Visa2014Worksheet { Name = "OtherSite", Columns = Visa2014OtherSiteTransform.OtherSiteMainColumnOrder, Rows = batch.ImportRows },
            new Visa2014Worksheet { Name = "_DedupeMerged", Columns = Visa2014PersonTransform.InferColumns(batch.DedupeSummary.ToList(), Visa2014OtherSiteTransform.OtherSiteMainColumnOrder), Rows = batch.DedupeSummary.ToList() },
