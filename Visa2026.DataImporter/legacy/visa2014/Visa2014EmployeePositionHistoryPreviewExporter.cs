...
internal static class Visa2014EmployeePositionHistoryPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014EmployeePositionHistoryTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "entity", "EmployeePositionHistory"),
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/EmployeePositionHistory.yaml"),
        };
        ...
        [
            new Visa2014Worksheet
            {
                ...
                Columns = Visa2014EmployeePositionHistoryTransform.EmployeePositionHistoryMainColumnOrder,
                Rows = batch.ImportRows,
            },
            new Visa2014Worksheet
            {
                Name = "_Skipped",
                Columns = Visa2014PersonTransform.InferColumns(batch.Skipped.ToList(), Visa2014EmployeePositionHistoryTransform.EmployeePositionHistoryMainColumnOrder),
