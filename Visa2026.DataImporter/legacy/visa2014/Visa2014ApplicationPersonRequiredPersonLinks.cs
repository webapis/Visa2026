...
internal static class Visa2014ApplicationPersonRequiredPersonLinks
{
    ...
    /// </summary>
    public static (int Education, int Address, int Position, int Travel) BackfillFromRoster(
        IObjectSpace objectSpace,
        bool dryRun,
        bool education = true,
        bool address = true,
        ...
        bool travel = true)
    {
        ...
        return (educationChanged, addressChanged, positionChanged, travelChanged);
    }
