...
internal static class Visa2014ApplicationItemPreviewExporter
{
    public static Visa2014PersonImportBatch PrepareImportBatch(
        ...
        int? maxRows,
        bool verbose) =>
        Visa2014ApplicationItemTransform.PrepareImportBatch(connectionString, lookupTranslationPaths, maxRows, verbose);
        ...
        string? legacySourceId = null)
    {
        ...
        var metaRows = new List<IReadOnlyDictionary<string, object?>>
        {
            ...
            Row("_key", "entity", "ApplicationItem"),
            ...
            Row("_key", "fieldMap", "legacy/visa2014/field-maps/ApplicationItem.yaml"),
        };
        ...
        [
            new Visa2014Worksheet
            {
                ...
                Columns = Visa2014ApplicationItemTransform.ApplicationItemMainColumnOrder,
            ...
            new Visa2014Worksheet
            {
                ...
                Columns = Visa2014PersonTransform.InferColumns(
                    ...
                    Visa2014ApplicationItemTransform.ApplicationItemMainColumnOrder),
            ...
            new Visa2014Worksheet
            {
                ...
                Columns = Visa2014PersonTransform.InferColumns(
                    ...
                    ["_dedupeGroupId", "key", "normalizedValue", "memberCount", "canonical_legacyRowId", "canonicalRule"]),
