...
- `ApplicationDetailViewDefaultTabController` --references--> `Application`  [EXTRACTED]
  Visa2026.Blazor.Server/Controllers/ApplicationDetailViewDefaultTabController.cs → Visa2026.Module/BusinessObjects/Application.cs
- `ApplicationItemLookupDefaultsController` --references--> `ApplicationItem`  [EXTRACTED]
  Visa2026.Blazor.Server/Controllers/ApplicationItemLookupDefaultsController.cs → Visa2026.Module/BusinessObjects/ApplicationItem.cs
- `PersonDetailViewBlazorUrlController` --references--> `Person`  [EXTRACTED]
  Visa2026.Blazor.Server/Controllers/PersonDetailViewBlazorUrlController.cs → Visa2026.Module/BusinessObjects/Person.cs
- `PersonDetailViewIssuedDocumentsLayoutController` --references--> `Person`  [EXTRACTED]
  Visa2026.Blazor.Server/Controllers/PersonDetailViewIssuedDocumentsLayoutController.cs → Visa2026.Module/BusinessObjects/Person.cs
- `ApplicationReportPackageModel` --references--> `ApplicationWordReportPackageCatalogEntry`  [EXTRACTED]
  Visa2026.Blazor.Server/Editors/ApplicationReportPackageModel.cs → Visa2026.Module/Services/WordReports/ApplicationWordReportPackageCatalog.cs
...
Cohesion: 0.11
Nodes (14): DxGridListEditor, IGrid, ListViewGridTotalCountConfigurator, Action, CancellationToken, CancellationTokenSource, EventArgs, EventHandler (+6 more)
