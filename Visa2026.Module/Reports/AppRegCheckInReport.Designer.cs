namespace Visa2026.Module.Reports
{
    partial class AppRegCheckInReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            //
            // Printable width = 826.7717 - 100 (left) - 100 (right) = 626.7717F
            //
            ...
            //
            // xrLabelBody1 — paragraph 1: count in bold via markup, full-width, justified
            //
            this.xrLabelBody1.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
                new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text",
                    "'Hatymyzyň goşundysynda görkezilen sanawdaky <b>' + [TotalPersonCount] + ' (' + [TotalPersonCountText] + ')</b> sany daşary ýurt raýatynyň Türkmenistana gelendigi sebäpli hasaba almagyňyzy Sizden haýyş edýäris.'")
            });
            this.xrLabelBody1.AllowMarkupText = true;
            this.xrLabelBody1.CanGrow = true;
            this.xrLabelBody1.Font = new DevExpress.Drawing.DXFont("Times New Roman", 15F);
            this.xrLabelBody1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 155F);
            this.xrLabelBody1.Multiline = true;
            this.xrLabelBody1.Name = "xrLabelBody1";
            this.xrLabelBody1.SizeF = new System.Drawing.SizeF(626.7717F, 90F);
            this.xrLabelBody1.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopJustify;
            this.xrLabelBody1.WordWrap = true;
            //
            // xrLabelBody2 — paragraph 2: static responsibility statement, full-width, justified
            //
            this.xrLabelBody2.CanGrow = true;
            this.xrLabelBody2.Font = new DevExpress.Drawing.DXFont("Times New Roman", 15F);
            this.xrLabelBody2.LocationFloat = new DevExpress.Utils.PointFloat(0F, 260F);
            this.xrLabelBody2.Multiline = true;
            this.xrLabelBody2.Name = "xrLabelBody2";
            this.xrLabelBody2.SizeF = new System.Drawing.SizeF(626.7717F, 80F);
            ...
            //
            // Detail — sized to contain all content with 15pt font
            //
