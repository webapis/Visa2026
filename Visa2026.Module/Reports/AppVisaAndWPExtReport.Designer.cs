namespace Visa2026.Module.Reports
{
    partial class AppVisaAndWPExtReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Y=230F — 10F below greeting end (185+35=220). Standard body start after greeting.
            //
            ...
            // Person count appears twice; [VisaPeriod_NameTm] and [VisaCategory_NameTm] are dynamic.
            // Font: Times New Roman 15pt | Justified | First-line indent: 0.5 inch (\fi720).
            ...
            // Font: Times New Roman 15pt | Justified | First-line indent: 0.5 inch (\fi720).
            // Y=466F — 8F gap after body2 end (378+80=458). Standard §3 paragraph gap.
            //
            ...
            this.xrRichBody3.LocationFloat = new DevExpress.Utils.PointFloat(0F, 466F);
            ...
            // Y=554F — 8F gap after body3 end (466+80=546). Standard §3 paragraph gap.
            //
            ...
            this.xrLabelAttachments.LocationFloat = new DevExpress.Utils.PointFloat(0F, 554F);
