...
public static partial class VisaUiMessageCatalog
{
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new(StringComparer.Ordinal)
    {
        ...
        {
            ["en-US"] = "ApplicationProfileInstance fields cannot be changed after ministry or migration progress was recorded.",
        ...
        ["ApplicationProfileInstancePerson.RosterLockedWhenWorkflowTerminal"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationRosterMergeLine.ArchivedPersonWarning"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationRosterMergeLine.SelectPassportBeforeVisa"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationRosterMergeLine.SelectPersonFirst"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        {
            ["en-US"] = "Select the linked record on the ApplicationProfileInstance Item tab first.",
        ...
        ["ApplicationProfileInstanceProgress.CannotAdvanceFromTerminal"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.DateCannotBeBeforePrevious"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.FirstStepMustBeOfficePreparation"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.InvalidForRoute"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.InvalidStateLocationPair"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.InvalidTransition"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.ListLabel.MigrationService"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Migration service",
            ["tr-TR"] = "Göç Dairesi",
            ["tk-TM"] = "Migrasiýa gullugy",
        ...
        ["ApplicationProfileInstanceProgress.ListLabel.Office"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Office",
            ["tr-TR"] = "Ofis",
            ["tk-TM"] = "Ofis",
        ...
        ["ApplicationProfileInstanceProgress.LocationNotAllowedForRoute"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MigrationSlaProfileRequired"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MinistryLetterPreview.Empty"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MinistryLetterPreview.Title"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MinistryLetters.Empty"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MinistryLetters.NoApplication"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MinistryLetters.Title"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.MinistryReviewSlaRequired"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.OnlyLastStepDeletable"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.ProjectContractRequired"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgress.Sla.Ok"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "{0}: day {1} of {2}",
            ["tr-TR"] = "{0}: {1}. gün / {2}",
            ["tk-TM"] = "{0}: {1}-nji gün / {2}",
        ...
        ["ApplicationProfileInstanceProgress.Sla.Overdue"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "{0}: day {1} of {2} (overdue)",
            ["tr-TR"] = "{0}: {1}. gün / {2} (süre aşımı)",
            ["tk-TM"] = "{0}: {1}-nji gün / {2} (möhlet geçdi)",
        ...
        ["ApplicationProfileInstanceProgress.Sla.Warning"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "{0}: day {1} of {2} (warning)",
            ["tr-TR"] = "{0}: {1}. gün / {2} (uyarı)",
            ["tk-TM"] = "{0}: {1}-nji gün / {2} (duýduryş)",
        ...
        ["ApplicationProfileInstanceProgress.StateNotAllowedForRoute"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgressProfile.MinistryDepth.Many"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "{0} ministries",
            ["tr-TR"] = "{0} bakanlık",
            ["tk-TM"] = "{0} ministrlik",
        ...
        ["ApplicationProfileInstanceProgressProfile.MinistryDepth.None"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgressProfile.MinistryDepth.One"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "one ministry",
            ["tr-TR"] = "tek bakanlık",
        ...
        ["ApplicationProfileInstanceProgressProfile.MinistryDepth.Two"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgressRoute.DirectToMigrationService"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgressRoute.Unknown"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        ["ApplicationProfileInstanceProgressRoute.ViaMinistries"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        {
            ["en-US"] = "ApplicationProfileInstance field \"{0}\" is empty.",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance type \"{1}\" (code {0}) is not ready for use.",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance type",
            ["tr-TR"] = "Başvuru türü",
            ["tk-TM"] = "Arza görnüşi",
            ["ru-RU"] = "Тип заявления",
        },
        ...
        ["HeaderDocumentCopies.Subtitle.ApplicationProfileInstance"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "ApplicationProfileInstance {0}",
            ["tr-TR"] = "Başvuru {0}",
            ["tk-TM"] = "Arza {0}",
            ["ru-RU"] = "Заявка {0}",
        },
        ...
        ["Pdf.Packaging.ApplicationProfileInstanceId"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "ApplicationProfileInstance ID: {0}",
        ...
        {
            ["en-US"] = "Gaps detected (included category + eligible ApplicationRosterMergeLine branch, but no usable FileData in the ZIP and/or no mergeable PDF slice where applicable):",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance items, work permits, and invitations appear here after you process applications. Add passports, education, and other person data in the tabs above.",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance items and invitations appear here after you process applications. Add passports and other person data in the tabs above.",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance date",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance #",
            ["tr-TR"] = "Başvuru No",
            ["tk-TM"] = "Arza belgisi",
            ["ru-RU"] = "№ заявления",
        },
        ...
        {
            ["en-US"] = "ApplicationProfileInstances",
            ["tr-TR"] = "Başvurular",
            ["tk-TM"] = "Arzalar",
            ["ru-RU"] = "Заявления",
        },
        ...
        ["ReportDashboard.Category.ApplicationProfileInstance"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Application",
            ["tr-TR"] = "Başvuru",
            ["tk-TM"] = "Ýüztutma",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance (direct migration)",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance (via ministry)",
        ...
        {
            ["en-US"] = "Address of Residence: ApplicationRosterMergeLine.CurrentAddressOfResidence with Application.ApplicationDate in range",
            ["tr-TR"] = "İkamet adresi: ApplicationRosterMergeLine.CurrentAddressOfResidence, Application.ApplicationDate aralıkta",
            ["tk-TM"] = "Ýaşaýyş salgysy: ApplicationRosterMergeLine.CurrentAddressOfResidence, Application.ApplicationDate aralykda",
            ["ru-RU"] = "Адрес проживания: ApplicationRosterMergeLine.CurrentAddressOfResidence с Application.ApplicationDate в диапазоне",
        },
        ["ReportDashboard.Chrome.Title.Date.Education"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Education: ApplicationRosterMergeLine.CurrentEducation with Application.ApplicationDate in range",
            ["tr-TR"] = "Eğitim: ApplicationRosterMergeLine.CurrentEducation, Application.ApplicationDate aralıkta",
            ["tk-TM"] = "Bilim: ApplicationRosterMergeLine.CurrentEducation, Application.ApplicationDate aralykda",
            ["ru-RU"] = "Образование: ApplicationRosterMergeLine.CurrentEducation с Application.ApplicationDate в диапазоне",
        },
        ["ReportDashboard.Chrome.Title.Date.Medical"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Medical Records: ApplicationRosterMergeLine.CurrentMedicalRecord with Application.ApplicationDate in range",
            ["tr-TR"] = "Sağlık kayıtları: ApplicationRosterMergeLine.CurrentMedicalRecord, Application.ApplicationDate aralıkta",
            ["tk-TM"] = "Saglyk ýazgylary: ApplicationRosterMergeLine.CurrentMedicalRecord, Application.ApplicationDate aralykda",
            ["ru-RU"] = "Медкарты: ApplicationRosterMergeLine.CurrentMedicalRecord с Application.ApplicationDate в диапазоне",
        },
        ["ReportDashboard.Chrome.Title.Date.Passport"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Passport: ApplicationRosterMergeLine.CurrentPassport with Application.ApplicationDate in range",
            ["tr-TR"] = "Pasaport: ApplicationRosterMergeLine.CurrentPassport, Application.ApplicationDate aralıkta",
            ["tk-TM"] = "Pasport: ApplicationRosterMergeLine.CurrentPassport, Application.ApplicationDate aralykda",
            ["ru-RU"] = "Паспорт: ApplicationRosterMergeLine.CurrentPassport с Application.ApplicationDate в диапазоне",
        },
        ["ReportDashboard.Chrome.Title.Date.Position"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Position History: ApplicationRosterMergeLine.CurrentPositionHistory with Application.ApplicationDate in range",
            ["tr-TR"] = "Pozisyon geçmişi: ApplicationRosterMergeLine.CurrentPositionHistory, Application.ApplicationDate aralıkta",
            ["tk-TM"] = "Wezipe taryhy: ApplicationRosterMergeLine.CurrentPositionHistory, Application.ApplicationDate aralykda",
            ["ru-RU"] = "История должностей: ApplicationRosterMergeLine.CurrentPositionHistory с Application.ApplicationDate в диапазоне",
        },
        ...
        {
            ["en-US"] = "ApplicationProfileInstance Type · Process State",
        ...
        {
            ["en-US"] = "ApplicationProfileInstance Status",
        ...
        {
            ["en-US"] = "Open the full ApplicationProfileInstance record for the selected row",
