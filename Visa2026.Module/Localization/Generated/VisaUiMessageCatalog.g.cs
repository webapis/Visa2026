...
public static partial class VisaUiMessageCatalog
{
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new(StringComparer.Ordinal)
    {
        ...
        {
            ["en-US"] = "Open edits the shared chain. Default for this template stays on the wizard radios.",
            ["tr-TR"] = "Aç, paylaşılan zinciri düzenler. Bu şablonun varsayılanı sihirbaz radyolarında kalır.",
            ["tk-TM"] = "Aç paýlaşylan zynjyry redaktirleýär. Bu şablonyň deslapky belligi jadygöý radio-larynda galýar.",
            ["ru-RU"] = "Открыть правит общую цепочку. Значение по умолчанию для шаблона остаётся на радиокнопках мастера.",
        },
        ...
        {
            ["en-US"] = "Create the first shared ministry chain. Officers pick it as Default on the wizard after Refresh.",
            ["tr-TR"] = "İlk paylaşılan bakanlık zincirini oluşturun. Memurlar yenilemeden sonra sihirbazda Varsayılan olarak seçer.",
            ["tk-TM"] = "Ilkinji paýlaşylan ministrlik zynjyryny dörediň. Işgärler täzelemekden soň jadygöýde deslapky hökmünde saýlaýar.",
            ["ru-RU"] = "Создайте первую общую цепочку министерств. Сотрудники выберут её как значение по умолчанию в мастере после обновления.",
        },
        ["ApprovalLegProfile.Slot.EmptyFooter"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["en-US"] = "Default for this template stays on the wizard radios after the first chain exists.",
            ["tr-TR"] = "İlk zincir oluşunca bu şablonun varsayılanı sihirbaz radyolarında kalır.",
            ["tk-TM"] = "Ilkinji zynjyr döredilenden soň bu şablonyň deslapkysy jadygöý radio-larynda galýar.",
            ["ru-RU"] = "После появления первой цепочки значение по умолчанию для шаблона остаётся на радиокнопках мастера.",
        },
        ...
        {
            ["en-US"] = "Create adds a shared catalog chain. Then Refresh on the wizard to set Default.",
            ["tr-TR"] = "Oluştur paylaşılan bir zincir ekler. Varsayılanı ayarlamak için sihirbazda Yenile’ye basın.",
            ["tk-TM"] = "Döret paýlaşylan katalog zynjyryny goşýar. Deslapkyny sazlamak üçin jadygöýde Täzele.",
            ["ru-RU"] = "Создать добавляет общую цепочку. Затем обновите мастер, чтобы задать значение по умолчанию.",
        },
