...
{
    /// <summary>Stable keys for <see cref="ExpirationAlertRule.BusinessObjectKey"/> and expiration helpers.</summary>
    public static class ExpirationAlertBusinessObjectKeys
    {
        ...
        public const string BorderZone = nameof(BorderZone);
    }
}
