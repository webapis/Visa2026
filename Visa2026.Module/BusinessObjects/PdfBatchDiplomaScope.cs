...
{
    /// <summary>All non-deleted educations on <see cref="ApplicationRosterMergeLine.Person"/> (ordered by graduation year desc).</summary>
    [XafDisplayName("All educations")]
    AllEducations = 0,

    /// <summary>Only <see cref="ApplicationRosterMergeLine.CurrentEducation"/> when set on the line (§1.3).</summary>
