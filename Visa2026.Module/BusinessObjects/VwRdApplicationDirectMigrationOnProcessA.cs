...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (direct migration) — On Process (A)
/// from <c>vw_rd_application_direct_migration_on_process_a</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
