...
/// <summary>
/// Report Dashboard Application (via ministry) — Invitation Completed (P)
/// from <c>vw_rd_application_via_ministry_invitation_completed</c> (one row per ApplicationItem).
/// </summary>
[DefaultClassOptions]
