...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Invitation Completed (P)
/// from <c>vw_rd_application_via_ministry_invitation_completed</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Invitation Completed (P)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryInvitationCompleted : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
