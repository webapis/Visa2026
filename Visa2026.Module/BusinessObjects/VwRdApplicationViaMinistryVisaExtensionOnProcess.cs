...
/// <summary>
/// Report Dashboard Application (via ministry) — Visa Extension on Process (P)
/// from <c>vw_rd_application_via_ministry_visa_extension_on_process</c> (one row per ApplicationItem).
/// </summary>
[DefaultClassOptions]
