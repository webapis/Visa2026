...
/// <summary>
/// Report Dashboard Application (via ministry) — Visa Extension Completed (P)
/// from <c>vw_rd_application_via_ministry_visa_extension_completed</c> (one row per ApplicationItem).
/// </summary>
[DefaultClassOptions]
