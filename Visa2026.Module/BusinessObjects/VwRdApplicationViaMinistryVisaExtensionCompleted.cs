...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Visa Extension Completed (P)
/// from <c>vw_rd_application_via_ministry_visa_extension_completed</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Visa Extension Completed (P)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryVisaExtensionCompleted : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
