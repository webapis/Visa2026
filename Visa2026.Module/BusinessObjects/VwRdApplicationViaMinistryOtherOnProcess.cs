...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Other on Process (P)
/// from <c>vw_rd_application_via_ministry_other_on_process</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Other on Process (P)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryOtherOnProcess : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
