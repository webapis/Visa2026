...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Other Process Completed (P)
/// from <c>vw_rd_application_via_ministry_other_completed</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Other Process Completed (P)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryOtherCompleted : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
