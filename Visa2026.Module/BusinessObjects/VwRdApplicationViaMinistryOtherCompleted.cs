...
/// <summary>
/// Report Dashboard Application (via ministry) — Other Process Completed (P)
/// from <c>vw_rd_application_via_ministry_other_completed</c> (one row per ApplicationItem).
/// </summary>
[DefaultClassOptions]
