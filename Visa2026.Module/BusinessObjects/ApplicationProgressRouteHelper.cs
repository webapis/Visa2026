...

{
...

    {
...

        {
            ...
            return GetAllowedLocationCodes(route.Value, legCount);
        ...
        public static IReadOnlyList<string> GetAllowedLocationCodes(
            ...
            GetAllowedLocationCodes(route, MapLegacyDepthToLegCount(depth));
...

        {
            ...
            var list = new List<string>(legCount + 2) { ApplicationProgressLocationCodes.AtOffice };

            list.AddRange(ApplicationProgressLegCodes.GetMinistryLocationCodesUpToLegCount(legCount));
...

        {
            ...
            var list = new List<string> { ApplicationProgressLocationCodes.AtOffice };

            list.AddRange(ApplicationProgressLegCodes.GetMinistryLocationCodesUpToLegCount(ApplicationProgressLegCodes.MaxLegCount));
