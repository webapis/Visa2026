...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Invitation on Process (P)
/// from <c>vw_rd_application_via_ministry_invitation_on_process</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Invitation on Process (P)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryInvitationOnProcess : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
    ...
    // Period/Category/Type not on this view (P without V dims).
    string IVwRdApplicationViaMinistryRow.PeriodLabel { get => string.Empty; set { } }
    string IVwRdApplicationViaMinistryRow.CategoryLabel { get => string.Empty; set { } }
    string IVwRdApplicationViaMinistryRow.TypeLabel { get => string.Empty; set { } }
}
