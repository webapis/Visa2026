...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Invitation Completed (V)
/// from <c>vw_rd_application_via_ministry_invitation_completed_by_period_category_type</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
