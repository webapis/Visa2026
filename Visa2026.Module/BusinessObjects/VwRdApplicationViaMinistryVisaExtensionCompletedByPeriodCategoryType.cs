...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Visa Extension Completed (V)
/// from <c>vw_rd_application_via_ministry_visa_extension_completed_by_period_category_type</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Visa Extension Completed (V)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryVisaExtensionCompletedByPeriodCategoryType : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
    ...
    [Browsable(false)]
    public virtual Guid? VisaOnExtensionOid { get; set; }

    [ForeignKey(nameof(VisaOnExtensionOid))]
    [ModelDefault("Caption", "Visa on extension")]
    public virtual Visa VisaOnExtension { get; set; }

    [Browsable(false)]
    public virtual string VisaOnExtensionNumber { get; set; }

    [Browsable(false)]
    public virtual Guid? IssuedVisaOid { get; set; }

    [ForeignKey(nameof(IssuedVisaOid))]
    [ModelDefault("Caption", "Issued Visa")]
    public virtual Visa IssuedVisa { get; set; }

    [Browsable(false)]
    public virtual string IssuedVisaNumber { get; set; }
