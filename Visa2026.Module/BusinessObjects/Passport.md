...
| Property Name | Data Type | Description | Constraints / Validation Rules |
 ...
 | `IssueDate` | `DateTime?` | The date the passport was issued. | Required; ImmediatePostData. |
 | `ExpirationDate` | `DateTime?` | The date the passport expires. | Required; ImmediatePostData. |
 | `Authority` | `string` | The authority that issued the passport. | Optional; Max 100 chars. |
 | `Person` | `Person` (Lookup) | A reference to the passport holder. | Required. |
 |`CurrentVisa`|`Visa`|The currently active visa for this passport.| AllowEdit=false|
 ...
 | `Documents` | `List<PassportDocument>` | A collection of documents associated with this passport. | Aggregated. |
---
...
-   **Immediate Post Data**: The `IssueDate` and `ExpirationDate` properties use `ImmediatePostData`.