...
/// <summary>
/// Report Dashboard ApplicationProfileInstance (via ministry) — Visa Extension on Process (V)
/// from <c>vw_rd_application_via_ministry_visa_extension_on_process_by_period_category_type</c> (one row per ApplicationRosterMergeLine).
/// </summary>
[DefaultClassOptions]
[NavigationItem(false)]
[DefaultProperty(nameof(ApplicationNumber))]
[ModelDefault("Caption", "Visa Extension on Process (V)")]
[ModelDefault("AllowEdit", "False")]
[ModelDefault("AllowNew", "False")]
[ModelDefault("AllowDelete", "False")]
public class VwRdApplicationViaMinistryVisaExtensionOnProcessByPeriodCategoryType : IVwRdApplicationViaMinistryRow
{
    [Key]
    [Browsable(false)]
