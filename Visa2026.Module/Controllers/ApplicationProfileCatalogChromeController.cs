...
public sealed class ApplicationProfileCatalogChromeController : ViewController
{
    private const string Reason = "ApplicationProfileCatalog";
    ...
    {
        if (View is not DetailView detailView || detailView.Id != ApplicationProfileCatalogViewIds.DetailView)
            return;
