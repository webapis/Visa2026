...
/// New nested templates may be added while locked; Recycle Bin recycle/restore/purge of existing
/// templates is allowed; Shared-tab exclude of a Category/Global include is allowed; replacing
/// an existing template's Word/Excel file (Review placeholders) is allowed; other
/// existing template row edits stay blocked.
/// </summary>
