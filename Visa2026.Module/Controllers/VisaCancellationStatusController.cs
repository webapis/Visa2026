...
{
    public class VisaCancellationStatusController : ObjectViewController<ListView, VisaCancellationStatus>
    {
        private VisaCancellationFilterService _filterService;

        protected override void OnActivated()
        {
            base.OnActivated();
            _filterService = Application.ServiceProvider?.GetService<VisaCancellationFilterService>();
