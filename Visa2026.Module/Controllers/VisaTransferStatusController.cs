...
{
    public class VisaTransferStatusController : ObjectViewController<ListView, VisaTransferStatus>
    {
        private readonly SimpleAction _openApplicationAction;
        private VisaTransferFilterService _filterService;

        public VisaTransferStatusController()
        {
        ...
        {
            base.OnActivated();
            _filterService = Application.ServiceProvider?.GetService<VisaTransferFilterService>();
        ...
        {
            var status = View.CurrentObject as VisaTransferStatus;
