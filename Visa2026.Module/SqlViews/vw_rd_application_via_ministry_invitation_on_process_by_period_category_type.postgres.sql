...
SELECT
    b."ID", b."ApplicationProfileInstanceOid", b."ApplicationItemOid", b."PersonOid", b."CurrentStateID",
...
LEFT JOIN "ApplicationProfileInstances" a ON a."ID" = b."ApplicationProfileInstanceOid" AND COALESCE(a."GCRecord", 0) = 0
