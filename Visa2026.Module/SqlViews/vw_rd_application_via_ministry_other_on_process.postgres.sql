...
DROP VIEW IF EXISTS vw_rd_application_via_ministry_other_on_process;
CREATE VIEW vw_rd_application_via_ministry_other_on_process AS
...
INNER JOIN "ApplicationTypes" at
   ...
   AND COALESCE(at."CanIssueInvitation", FALSE) = FALSE
   AND (at."Name" IS NULL OR at."Name" NOT IN ('App_Visa_Ext','App_Visa_Ext_According_to_WP','App_Visa_Ext_FM','App_Visa_and_WP_Ext'))
