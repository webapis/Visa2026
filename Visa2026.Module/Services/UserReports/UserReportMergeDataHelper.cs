...
public static class UserReportMergeDataHelper
{
    ...
    public static Dictionary<string, object> BuildApplicationHeaderDictionary(ApplicationProfileInstance application)
    {
        var data = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["FamilyMember_SponsorPhraseTm"] = application.FamilyMember_SponsorPhraseTm ?? string.Empty,
    ...
    public static Dictionary<string, object> BuildSanawyRowDictionary(ApplicationRosterMergeLine item, int rowNo) =>
        WithAliasKeys(new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["FM_EducationLevelAndInstitutionTm"] = item.FM_EducationLevelAndInstitutionTm ?? string.Empty,
            ["FM_SpecialtyTm"] = item.FM_SpecialtyTm ?? string.Empty,
            ["FM_WezipesiTm"] = item.FM_WezipesiTm ?? string.Empty,
            ...
            ["Application_WorkPermitLocation_NameTm"] = item.Application_WorkPermitLocation_NameTm ?? string.Empty,
