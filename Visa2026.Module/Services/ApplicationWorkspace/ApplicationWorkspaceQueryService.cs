    ...
    private static ApplicationProfileInstance? LoadInstance(IObjectSpace objectSpace, Guid applicationId)
    {
        try
        {
            return objectSpace.GetObjectsQuery<ApplicationProfileInstance>()
                ...
                .Include(a => a.ToCity)
                    .ThenInclude(c => c!.Region)
                .Include(a => a.FromRegion)
                .Include(a => a.ToRegion)
                .Include(a => a.Region)
                .Include(a => a.City)
                    .ThenInclude(c => c.Region)
...
#pragma warning restore CS0618
                .Include(a => a.BusinessTripLodging)
                    .ThenInclude(l => l!.City)
                .Include(a => a.BusinessTripHotel)
                    .ThenInclude(h => h!.City)
                .Include(a => a.BusinessTripHospital)
                    .ThenInclude(h => h!.City)
                .Include(a => a.BusinessTripOtherSite)
