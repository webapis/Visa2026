...
{
    /// <summary>
    /// Visa cancellation letter for App_Cancel_Visa (Group D — fixed national migration chief recipient).
    /// "... wizasyny ýatyrmagy'ňyzy Sizden haýyş edýäris."
    /// Template: Visa2026.Module.Resources.App_Cancel_Visa_Letter.docx
    /// </summary>
    public class AppCancelVisaLetterReportDef : IWordReportDefinition
    {
        public string[] ApplicableApplicationTypeNames => new[] { "App_Cancel_Visa" };

        public bool IsApplicable(Application application) => true;

        public string GetFileName(Application application) =>
            $"WizayaYatyrylmak_{application.FullApplicationNumber}_{DateTime.Now:yyyyMMdd}.docx";
        ...
        public Task GenerateAsync(Application application, IWordFormFillerService wordService, Stream outputStream)
        {
            ...
            const string res = "Visa2026.Module.Resources.App_Cancel_Visa_Letter.docx";
