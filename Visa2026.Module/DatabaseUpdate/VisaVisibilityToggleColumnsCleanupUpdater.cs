...
/// <summary>
/// Drops <c>Visas.HasInvitation</c> and <c>Visas.HistoricalImport</c>; optional issuing/invitation links use the gear toggle on <see cref="BusinessObjects.Visa"/>.
/// </summary>
public sealed class VisaVisibilityToggleColumnsCleanupUpdater : ModuleUpdater
{
    public VisaVisibilityToggleColumnsCleanupUpdater(IObjectSpace objectSpace, Version currentDBVersion)
    ...
    public override void UpdateDatabaseBeforeUpdateSchema()
    {
        ...
        DropColumnIfExists("Visas", "HasInvitation");
        DropColumnIfExists("Visas", "HistoricalImport");
    }
