...
/// <summary>
/// Drops legacy <c>Application.CurrentState</c> and <c>Application.ExpirationDate</c> columns before EF removes them from the model.
/// </summary>
public sealed class ApplicationLegacyColumnsCleanupUpdater : ModuleUpdater
{
    public ApplicationLegacyColumnsCleanupUpdater(IObjectSpace objectSpace, Version currentDBVersion)
