...
/// <summary>
/// Drops legacy <c>IsActive</c> columns from person-history and expiration BO tables before EF removes them from the model.
/// </summary>
public sealed class PersonIsActiveColumnsCleanupUpdater : ModuleUpdater
{
    ...
    public PersonIsActiveColumnsCleanupUpdater(IObjectSpace objectSpace, Version currentDBVersion)
    ...
    public override void UpdateDatabaseBeforeUpdateSchema()
    {
        ...
        foreach (var tableName in TableNames)
            DropIsActiveColumnIfExists(tableName);
    }
    ...
    private void DropIsActiveColumnIfExists(string tableName) =>
        DropColumnIfExists(tableName, "IsActive");
