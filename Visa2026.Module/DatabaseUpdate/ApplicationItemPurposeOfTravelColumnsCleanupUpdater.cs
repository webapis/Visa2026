...
{
    public ApplicationItemPurposeOfTravelColumnsCleanupUpdater(IObjectSpace objectSpace, Version currentDBVersion)
    ...
    public override void UpdateDatabaseBeforeUpdateSchema()
    {
        ...
        DropColumnIfExists("ApplicationItems", "PurposeOfTravelID");
        DropColumnIfExists("TravelHistories", "PurposeOfTravelID");
    }
