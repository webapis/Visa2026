            ...
            if (element is IModelLayoutGroup group)
            {
                ...
                else
                {
                    ...
                    group.SetValue("CustomCSSClassName", "xaf-fill-available");
                     ...
                     && layoutItem.ViewItem?.Id == nameof(OrganizationCatalogsHost.CatalogsUi))
            {
