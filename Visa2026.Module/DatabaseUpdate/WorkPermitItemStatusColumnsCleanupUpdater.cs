...
{
    public WorkPermitItemStatusColumnsCleanupUpdater(IObjectSpace objectSpace, Version currentDBVersion)
    ...
    public override void UpdateDatabaseBeforeUpdateSchema()
    {
        ...
        DropColumnIfExists("WorkPermitItems", "IsChanged");
        DropColumnIfExists("WorkPermitItems", "IsExtended");
    }
