...
**ApplicationProfileInstance profiles** (Çalik legacy — **generated** after Wave 0 Excel sign-off):

| JSON file | Entity | Generated by |
|-----------|--------|----------------|
| `application-profile.calik-energi.json` | `ApplicationProfile` | `scripts/visa2014-migration/catalogs/generate/ApplicationProfileTenant-CalikEnergi.ps1` |

Synced on deploy via `ApplicationProfileTenantCatalogSeedUpdater` (after `ApplicationProfileSeedUpdater` from `ApplicationType`). Not in `manifest.json` — dedicated seed updater. See [`docs/VISA2014_MIGRATION/APPLICATION_PROFILE_CATALOG_WAVE0.md`](../../../../docs/VISA2014_MIGRATION/APPLICATION_PROFILE_CATALOG_WAVE0.md).
