...
|-----------|--------|----------------|
| `approval-leg-profile.json` | `ApprovalLegProfile` + `ApprovalLegProfileMinistryLeg` | `scripts/local/Generate-ApprovalLegProfileCatalog.ps1` after `Generate-ProjectContractCalikEnergiCatalog.ps1` |
