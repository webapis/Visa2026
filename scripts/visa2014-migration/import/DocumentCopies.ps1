...
$steps = @(
    ...
    @{ Key='MedicalRecordDocument'; Name='MedicalRecord.MedicalRecordDocument'; Extra=(New-FileWaveExtra -Base @('--import-visa2014-files','--entity','MedicalRecord','--property','MedicalRecordDocument') -Flag '--id-map' -Entity 'Person') },
