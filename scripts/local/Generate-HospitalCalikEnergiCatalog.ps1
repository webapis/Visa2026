...
$preview = Join-Path $repoRoot 'Visa2026.DataImporter\legacy\visa2014\preview-export\Hospital-preview.calik-energi.xlsx'
$tenantDir = Join-Path $repoRoot 'Visa2026.Module\DatabaseUpdate\LookupCatalogs\tenant'
$outFile = Join-Path $tenantDir 'hospital.calik-energi.json'
...
Write-Host "Wrote $count hospital row(s) -> $outFile"
