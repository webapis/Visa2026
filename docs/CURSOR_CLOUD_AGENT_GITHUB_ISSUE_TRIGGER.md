...
1. Confirm the automation is **Active** in Cursor.
2. Open a test issue in the repo.
3. Check the workflow under **Actions** — the curl step should succeed (HTTP 2xx).
4. In Cursor, open the automation → **Run History** and confirm a new cloud agent run started.
5. If you get **401**, regenerate the auth header in the automation UI and update `CURSOR_WEBHOOK_AUTH`.
