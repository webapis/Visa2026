...
- Operational visibility layer: **Report Dashboard** (top-level nav, startup item) with charts and Excel / ListView drill-down — see [`REPORT_DASHBOARD.md`](REPORT_DASHBOARD.md). (Old State Dashboard tiles removed.)
