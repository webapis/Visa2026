...
**Status:** **Person**, **Passport**, **Visa**, **Education**, **EmployeePositionHistory**, **EmployeeSalary**, **AddressOfResidence** (+ lodging/hotel/hospital/other-site/private-house splits), **Application**, **ApplicationItem**, **ApplicationProgress**, **Invitation**, **InvitationItem**, **WorkPermit**, **WorkPermitItem**, **Rejection**, **RejectionItem**, **BorderZone**, and **BorderZoneItem** implemented via `--export-visa2014-preview --entity <Name>`. Later waves TBD.
