...
public static class WebApiServiceExtensions
{
        ...
        IConfiguration configuration)   // <-- required by AddXafWebApi
    {
        ...
        services.AddXafWebApi(configuration, options =>
        {
            ...
            options.BusinessObject<Visa2026.Module.BusinessObjects.BorderZoneName>();
            options.BusinessObject<Visa2026.Module.BusinessObjects.WorkPermittedLocationName>();
            ...
            options.BusinessObject<Visa2026.Module.BusinessObjects.Ministry>();
            options.BusinessObject<Visa2026.Module.BusinessObjects.CompanyProfile>();
