...
internal static class NavigationE2eHooks
{
    internal static IReadOnlyDictionary<string, string> TestIdsByNavigationItemId { get; } =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            [ApplicationProgressRouteNavigation.NavItemDirectMigration] = "nav-application-direct-migration",
            [ApplicationProgressRouteNavigation.NavItemViaMinistries] = "nav-application-via-ministries",
        };
    ...
    internal static IReadOnlyDictionary<string, string> TestIdsByNavigateUrl { get; } =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [ApplicationProgressRouteNavigation.ListViewDirectMigration] = "nav-application-direct-migration",
            [ApplicationProgressRouteNavigation.ListViewViaMinistries] = "nav-application-via-ministries",
        };
}
